...
EMAIL_ENCRYPTION = os.getenv('MAILER_ENCRYPTION')
...
# Celery settings
CELERY_BROKER_URL = f"redis://{CACHE_USERNAME}:{CACHE_PASSWORD}@{CACHE_HOST}:{CACHE_PORT}/0"
CELERY_RESULT_BACKEND = f"redis://{CACHE_USERNAME}:{CACHE_PASSWORD}@{CACHE_HOST}:{CACHE_PORT}/0"
